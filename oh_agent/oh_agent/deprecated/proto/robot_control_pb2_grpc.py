...
import proto.robot_control_pb2 as robot__control__pb2
...
class RobotControlServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.MoveToPosition = channel.unary_unary(
                ...
                request_serializer=robot__control__pb2.TargetPosition.SerializeToString,
                response_deserializer=robot__control__pb2.ControlResponse.FromString,
                _registered_method=True)
        self.StreamMove = channel.unary_stream(
                '/robot_control.v1.RobotControlService/StreamMove',
                request_serializer=robot__control__pb2.RobotDirection.SerializeToString,
                response_deserializer=robot__control__pb2.RobotState.FromString,
                _registered_method=True)
        ...
        self.StreamPickUpObject = channel.unary_stream(
                ...
                request_serializer=robot__control__pb2.PickOrPlaceCmd.SerializeToString,
                response_deserializer=robot__control__pb2.RobotState.FromString,
                _registered_method=True)
...
def add_RobotControlServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'MoveToPosition': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=robot__control__pb2.TargetPosition.FromString,
                    response_serializer=robot__control__pb2.ControlResponse.SerializeToString,
            ),
            'StreamMove': grpc.unary_stream_rpc_method_handler(
                    servicer.StreamMove,
                    request_deserializer=robot__control__pb2.RobotDirection.FromString,
                    response_serializer=robot__control__pb2.RobotState.SerializeToString,
            ),
            ...
            'StreamPickUpObject': grpc.unary_stream_rpc_method_handler(
                    ...
                    request_deserializer=robot__control__pb2.PickOrPlaceCmd.FromString,
                    response_serializer=robot__control__pb2.RobotState.SerializeToString,
            ),
...
class RobotControlService(object):
    ...
    def MoveToPosition(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/robot_control.v1.RobotControlService/MoveToPosition',
            robot__control__pb2.TargetPosition.SerializeToString,
            robot__control__pb2.ControlResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def StreamMove(request,
        ...
        return grpc.experimental.unary_stream(
            ...
            target,
            '/robot_control.v1.RobotControlService/StreamMove',
            robot__control__pb2.RobotDirection.SerializeToString,
            robot__control__pb2.RobotState.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def StreamPickUpObject(request,
        ...
        return grpc.experimental.unary_stream(
            ...
            target,
            '/robot_control.v1.RobotControlService/StreamPickUpObject',
            robot__control__pb2.PickOrPlaceCmd.SerializeToString,
            robot__control__pb2.RobotState.FromString,
            options,
            channel_credentials,
            insecure,
...
class CameraServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetImage = channel.unary_unary(
                ...
                request_serializer=robot__control__pb2.Empty.SerializeToString,
                response_deserializer=robot__control__pb2.ImageResponse.FromString,
                _registered_method=True)
        self.GetCameraConfig = channel.unary_unary(
                '/robot_control.v1.CameraService/GetCameraConfig',
                request_serializer=robot__control__pb2.Empty.SerializeToString,
                response_deserializer=robot__control__pb2.CameraConfig.FromString,
                _registered_method=True)
...
def add_CameraServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'GetImage': grpc.unary_unary_rpc_method_handler(
                    servicer.GetImage,
                    request_deserializer=robot__control__pb2.Empty.FromString,
                    response_serializer=robot__control__pb2.ImageResponse.SerializeToString,
            ),
            'GetCameraConfig': grpc.unary_unary_rpc_method_handler(
                    servicer.GetCameraConfig,
                    request_deserializer=robot__control__pb2.Empty.FromString,
                    response_serializer=robot__control__pb2.CameraConfig.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
...
class CameraService(object):
    ...
    def GetImage(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            '/robot_control.v1.CameraService/GetImage',
            robot__control__pb2.Empty.SerializeToString,
            robot__control__pb2.ImageResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def GetCameraConfig(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            '/robot_control.v1.CameraService/GetCameraConfig',
            robot__control__pb2.Empty.SerializeToString,
            robot__control__pb2.CameraConfig.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
